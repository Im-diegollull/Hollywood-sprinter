...
const LEVELS = [
  ...
  // Dos atletas reales por debajo de God Velocity: hacen falta unas 14.5
  // pulsaciones/s sostenidas para ganarles.
  { id: 9, name: 'Nacho & Juanpa',           fastest:  6.95, slowest:  7.10, runners: 2 },
  // El último eres tú: no hay rival más rápido que tu propio récord.
